...
%Auswertung zu Maschinenkonstante und Reibmoment
cd(data_path)
[filename_tdms,pathname_tdms] = uigetfile({'*.tdms'},'TDMS-Messdatenfiles für Ermittlung Maschinenkonstante auswählen','MultiSelect','on');
cd(ActPath)
